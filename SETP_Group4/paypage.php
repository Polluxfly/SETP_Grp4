...
<body>
	...
	<div class="container" style="display: flex; position: absolute; top: 35%;">
		<div class="row">
			<!--div class="col-sm"-->
				<div class="PaymentContainer" style="width: 690px; padding: 10px; top: 10%">
					<img src="visa_master.png" alt="visa_master_logo" style="width: 150px;">
